...
public class Pers {
    ...
    public Pers(int codiPers, String nombPers, String apelPers, byte[] fotoPers, int codiTipoPers, String genePers, Date fechNaciPers, String duiPers, String nitPers, String tipoSangPers, int codiUbicGeog, Date fechAlta, Date fechBaja, int esta) {
